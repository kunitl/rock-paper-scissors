...
function playGame() {
  ...
  function playRound(humanChoice, computerChoice) {
    ...
    if (capHumanChoice === computerChoice) {
      ...
      console.log(`You lose! ${capHumanChoice} is beaten by ${computerChoice}!`);
      computerScore += 1;
    }
    console.log(
      `Human's Score: ${humanScore}, Computer's Score: ${computerScore}`
  ...
  if (humanScore > computerScore) {
    console.log(
      `You win the game! Human's Score: ${humanScore}, Computer's Score: ${computerScore}`
    );
  } else if (computerScore > humanScore) {
    console.log(
      `You lose the game! Human's Score: ${humanScore}, Computer's Score: ${computerScore}`
    );
  } else {
    console.log(
      `It's tie for the game! Human's Score: ${humanScore}, Computer's Score: ${computerScore}`
    );
  }
}